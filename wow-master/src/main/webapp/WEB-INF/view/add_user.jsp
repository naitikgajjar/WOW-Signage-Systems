...
<html>
<head>
<title>Add User :: Digital Signage Solution</title>
				 ...
				 <div class="chit-chat-layer1">
							<div class="col-md-12 chit-chat-layer1-left">
								...
								<div class="chit-chat-heading">User Management</div>
									...
									<form action="/addUser" method="post" class="form-horizontal" modelAttribute="user">
									       <div class="form-group">
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-6"> 
											      <input type="text"  name="role" class="form-control" id="pwd" placeholder="Enter user role">
											    </div>
											</div>
