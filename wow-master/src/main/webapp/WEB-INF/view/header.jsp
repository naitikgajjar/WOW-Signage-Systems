...
<div class="header-main">
	<div class="header-left">
		<div class="logo-name">
			<a href="/office/index">
				<h1>WOW</h1> <!--<img id="logo" src="" alt="Logo"/>-->
			</a>
		</div>
		<!--search-box-->
		<!--  
				...
				<li class="dropdown profile_details_drop"><a href="#"
					...
					aria-expanded="false">
						<div class="profile_img">
							<span class="prfil-img"><img src="resources/images/p1.png"
								alt=""> </span>
							<div class="user-name">
								<p>
									User ID
					...
					<ul class="dropdown-menu drp-mnu">
						...
						<li><a href="/updatePassword"><i class="fa fa-key"></i> Change Password</a></li>
